...
def test10():
    ...
    def undo_redo_process(return_call: callable, possible_moves: list[Move], index: int):
        nonlocal game, history
        ...
        def undo():
            possible_moves[index].attempt_undo(game)
    ...
    def process_start():
        ...
        undo_redo_process(process_after, moves, 0)
